...
export const DATA_SOURCES: DataSource[] = [
  ...
  {
    id: "donor_industry",
    label: "Donor Money by Industry (FEC + industry map)",
    tier: "yellow",
    envKey: "FEC_API_KEY",
    needsKey: true,
    description: "Campaign donations bucketed by industry — rebuilt on FEC PAC filings after OpenSecrets retired its API (April 2025). PAC names are matched against LOBBY CAM's curated industry map. Cached 24h.",
  ...
  },
  {
    ...
    envKey: "FEC_API_KEY",
    needsKey: true,
    description: "Recent individual and PAC contributions from raw FEC filings.",
    docsUrl: "https://api.open.fec.gov/developers/",
    keyUrl: "https://api.data.gov/signup/",
  },
];
